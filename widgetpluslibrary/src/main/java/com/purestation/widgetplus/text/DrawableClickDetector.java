...
public class DrawableClickDetector {
    ...
    private Integer mWhichDrawableIsDectecting;
    ...
    public boolean detect(MotionEvent event) {
        if (event.getAction() == MotionEvent.ACTION_DOWN) {
            ...
            if (mWhichDrawableIsDectecting != null) {
                ((DrawableClickable) mTextView).performDrawableClick(mWhichDrawableIsDectecting);
                mWhichDrawableIsDectecting = null;
                return true;
            }
